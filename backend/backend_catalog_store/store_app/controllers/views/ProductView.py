...
from store_app.controllers.serializers.ProductSerializer import ProductSerializer, ProductPostSerializer
...
class ProductView(APIView):
    ...
    def get(self, request, id_business):
        try:
            products = ProductModel.objects.filter(id_business=id_business).select_related('id_category_product')
